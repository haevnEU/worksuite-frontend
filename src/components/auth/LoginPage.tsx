...
export const LoginPage: React.FC = () => {
  ...
  // Target route to redirect back to after successful login
  ...
  // Clear existing session and tokens immediately upon reaching the login screen
  useEffect(() => {
    logout();
  }, [logout]);
  ...
  useEffect(() => {
    try {
      ...
      // Backward compatibility for single user key
