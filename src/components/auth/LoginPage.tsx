...
export const LoginPage: React.FC = () => {
  ...
  // Ziel-Route ermitteln (falls ProtectedRoute den State übergeben hat)
  ...
  // 🔄 Falls bereits angemeldet, sofort zur Startseite oder Zielseite
  useEffect(() => {
    if (isAuthenticated) {
  ...
  useEffect(() => {
    try {
      ...
      // Abwärtskompatibilität: Falls noch der alte Einzelschlüssel existiert
