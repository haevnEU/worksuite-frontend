...
export const LogPasteModal: React.FC<LogPasteModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/75 backdrop-blur-xs p-4 animate-in fade-in duration-150">
      <div className="bg-[#10192c] border border-slate-800 rounded-2xl w-full max-w-2xl shadow-2xl flex flex-col overflow-hidden">
        <div className="p-4 border-b border-slate-800 bg-[#0b111e]/80 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="text-sm font-bold text-white">Paste Raw Logs</h3>
              <p className="text-[11px] text-slate-400">
                Paste log text, console output, or stacktraces directly
              </p>
            </div>
          </div>
          <button
