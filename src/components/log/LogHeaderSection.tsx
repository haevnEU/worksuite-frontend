...
import { FileTerminal, Lock, Upload } from "lucide-react";
...
export const LogHeaderSection: React.FC<LogHeaderSectionProps> = ({
  ...
  return (
    <div
      ...
      onDrop={handleDrop}
      className={`bg-[#10192c]/80 border rounded-xl p-6 flex flex-col md:flex-row md:items-center justify-between gap-4 backdrop-blur shadow-lg transition-all duration-200 ${
        isDragging
