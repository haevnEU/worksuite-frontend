...
export const AboutDatabaseSection: React.FC = () => {
    const { systemInfo, isLoading, refreshSystemInfo } = useAbout();
    const postgresInfo = systemInfo?.postgresInfo;
    const mongoInfo = systemInfo?.mongoInfo;
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 text-xs">
                ...
                {postgresInfo?.databaseProductName || "PostgreSQL (RDBMS)"}
                        ...
                        <div className="flex items-center gap-2">
                            {postgresInfo?.pingMs !== undefined && postgresInfo.pingMs >= 0 && (
