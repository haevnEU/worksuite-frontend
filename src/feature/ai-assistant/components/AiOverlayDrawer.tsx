...
import { Bot, Loader2, RefreshCw, Sparkles, XCircle } from "lucide-react";
...
export const AiOverlayDrawer: React.FC<AiOverlayDrawerProps> = ({
  ...
  const { generate, abort, output, isLoading, error, isReady, currentModel } =
    useAI();
    ...
    <>
      <div className="fixed bottom-6 right-6 z-40">
        <button
          ...
          title={`Run AI analysis with ${currentModel}`}
        >
          ...
          {isLoading && !output && (
            <div className="py-16 text-center space-y-3">
              ...
              <div className="space-y-1">
                <p className="text-sm font-bold text-white">{loadingTitle}</p>
